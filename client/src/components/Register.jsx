          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Create your account today and gain access to detailed
                information about countries, cultures, and geographical insights
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Join Country Explorer?
            </h2>
            <p className="text-lg text-gray-600">
              Create an account today and unlock a world of benefits and
              features
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Getting started with Country Explorer is simple and easy
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
                Join thousands of users who are discovering fascinating facts
                about countries, cultures, and landmarks around the globe.
              </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Discover the world's countries and their unique characteristics.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              © {new Date().getFullYear()} Country Explorer. All rights
              reserved.
            </p>
          </div>
        </div>
...
const benefits = [
  {
    ...
    description:
      "Create a profile and get personalized country recommendations based on your interests.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Bookmark your favorite countries and create custom collections for future reference.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Create and save travel itineraries with our comprehensive country information.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Access premium articles, guides, and in-depth analysis not available to non-members.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Join discussions with fellow travelers and country enthusiasts in our community forums.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Receive notifications about new countries, updated information, and platform features.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
...
const steps = [
  {
    ...
    description:
      "Sign up with your email and password to get started with Country Explorer.",
  },
  {
    title: "Explore Countries",
    description:
      "Browse our extensive database of countries, cultures, and geographical information.",
  },
  {
    title: "Save & Share",
    description:
      "Save your favorite countries, create collections, and share insights with friends.",
  },
];
