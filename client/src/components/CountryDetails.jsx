      ...
      <div className="flex flex-col md:flex-row gap-0 md:gap-8">
        ...
        <div className="flex-1 p-6 md:p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              <FaGlobeAmericas className="text-emerald-500 mt-1 mr-3 flex-shrink-0" />
              <div>
            ...
            {country.currencies && (
              <div className="flex items-start">
                <svg className="text-emerald-500 mt-1 mr-3 flex-shrink-0 w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
